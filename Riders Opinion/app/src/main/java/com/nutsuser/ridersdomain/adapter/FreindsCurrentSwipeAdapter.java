 ...
 */
public class FreindsCurrentSwipeAdapter extends RecyclerSwipeAdapter<FreindsCurrentSwipeAdapter.SimpleViewHolder> {


    private Context mContext;
    private ArrayList<Student> studentList;

    public FreindsCurrentSwipeAdapter(Context context, ArrayList<Student> objects) {
