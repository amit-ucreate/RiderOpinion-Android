 ...
 */
public class SucribeGridOjectdata {
    String destId;
    String destName;
    String videoUrl;
    String rating;
    ...
    String destLatitude;
    ArrayList<SubcribesGridImages> images = new ArrayList<>();
    ...
    public ArrayList<SubcribesGridImages> getImages() {
        return images;
    }

    public void setImages(ArrayList<SubcribesGridImages> images) {
        this.images = images;
    }
}
