...
import com.nutsuser.ridersdomain.fragments.SubcribeFragment;
...
public class MyFragmentStatePagerAdapter extends FragmentStatePagerAdapter {
    ...
    public MyFragmentStatePagerAdapter(FragmentManager fm, ArrayList<UtilsSubcribe.DummyItem> imageItemList) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        SubcribeFragment sampleFragment = (SubcribeFragment) SubcribeFragment.getInstance(/*dummyItem.getImageUrl(), dummyItem.getImageTitle()*/);
