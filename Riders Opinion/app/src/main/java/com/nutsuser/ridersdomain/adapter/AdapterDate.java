...
public class AdapterDate extends CaldroidGridAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // For reuse
        if (convertView == null) {
            cellView = inflater.inflate(R.layout.item_date, null);
        }
        ...
        TextView tvEvents = (TextView) cellView.findViewById(R.id.tvEvents);

        tvDate.setTextColor(context.getResources().getColor(R.color.light_brown));
