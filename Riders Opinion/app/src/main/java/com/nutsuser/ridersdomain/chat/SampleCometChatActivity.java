...
import com.nutsuser.ridersdomain.activities.BaseActivity;
...
public class SampleCometChatActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		showProgressDialog();
		SharedPreferenceHelper.initialize(SampleCometChatActivity.this);
		/*
		...
		cometchat = CometChat.getInstance(getApplicationContext(),
				SharedPreferenceHelper.get("10415x77177883eedf5255554e825180e563c1"));
		...
		new Handler().postDelayed(new Runnable() {
			...
			public void run() {
				...
				startActivity(new Intent(SampleCometChatActivity.this, UsersListActivity.class));
				finish();
